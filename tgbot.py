# -*- coding: utf-8 -*-
"""TGBot_integrated_model.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ZhVPOLcOWpzXVOWSOw24AeWn8zEthsx3

# Telegram-бот + обученная AltDiffusion/LoRA модель

Этот ноутбук объединяет:
1. загрузку `AltDiffusion-m9`;
2. применение LoRA-архитектуры к `unet`;
3. загрузку весов из `model_exp_3.pth`;
4. запуск Telegram-бота, который получает описание, генерирует картинку и отправляет её пользователю.
